  ...
  return (
    <div className="w-full max-w-md">
      <div className="text-center mb-8">
        <h1 className="text-2xl font-bold text-gray-900" style={{ fontFamily: 'Noto Serif, serif' }}>Забравена парола</h1>
        <p className="mt-2 text-gray-500 text-sm">Въведете имейла си и ще получите линк за нова парола</p>
      </div>
